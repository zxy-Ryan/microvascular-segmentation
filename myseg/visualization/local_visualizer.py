...
from myseg.registry import VISUALIZERS
from myseg.structures import SegDataSample
from myseg.utils import get_classes, get_palette
...
class SegLocalVisualizer(Visualizer):
    ...
    Examples:
        ...
        >>> import torch
        >>> from mmengine.structures import PixelData
        >>> from myseg.data import SegDataSample
        >>> from myseg.engine.visualization import SegLocalVisualizer

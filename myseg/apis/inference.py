...
from myseg.models import BaseSegmentor
from myseg.registry import MODELS
from myseg.structures import SegDataSample
from myseg.utils import SampleList, dataset_aliases, get_classes, get_palette
from myseg.visualization import SegLocalVisualizer
...
def init_model(config: Union[str, Path, Config],
    ...
    init_default_scope(config.get('default_scope', 'myseg'))
